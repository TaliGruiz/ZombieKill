...
void zombie::set_hpbar() {

	hpbar.setFillColor(Color::Red);
	hpbar.setSize(Vector2f((float)10.f, 7.f));
	//hpbar.setOrigin(300, 300);
}
...
void zombie::set_hpbarpos(Vector2f _poss) { hpbar.setPosition(_poss); }
